...
# Entrada: A entrada é composta por apenas uma linha contendo três números inteiros A, B e C (1 <= A,B,C <= 100),sendo respectivamente, a quantidade de pistas, a quantidade de pessoas por pista e a quantidade de alunos.
# Saída: Seu programa deve produzir uma linha contendo “S”, caso seja possível jogar no boliche com todos os alunos, ou uma linha contendo “N”, caso contrário.
