...
#Entrada: A entrada é composta na primeira linha por 2 inteiros, ‘T’ e ‘D’ (1 <= ‘T’,‘D’ <= 1000), representando o tamanho da estrada e a distância entre os pedágios. Na próxima linha serão fornecidos outros 2 inteiros, ‘V’ e ‘P’ (1 <= ‘V’,‘P’ <= 100), representando o valor por km de estrada e o valor por cada pedágio.
#Saída: Na saída será apresentado o valor total pela travessia da floresta.
